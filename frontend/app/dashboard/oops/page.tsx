        ...
        <div className="min-h-screen bg-gray-50">
            <header className="bg-white border-b shadow-sm sticky top-0 z-10">
                <div className="container mx-auto px-4 py-4 flex items-center gap-4">
                    ...
                    <h1 className="text-xl font-bold text-[#7b1fa2]">Object Oriented Programming</h1>
                </div>
            </header>
                    ...
                    {labs.map((p, index) => (
                        <div key={p.id} className="p-4 border-b last:border-b-0 flex items-center justify-between hover:bg-gray-50 transition-colors group">
                            ...
                            <Link href={`/dashboard/oops/${p.id}`}>
                                <Button variant="ghost" className="gap-2 text-[#7b1fa2] hover:text-[#6a1b9a] hover:bg-purple-50">
